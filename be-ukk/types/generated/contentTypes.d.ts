...
export interface ApiAdminAdmin extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::admin.admin'> &
      Schema.Attribute.Private;
    nama_admin: Schema.Attribute.String;
...
export interface ApiKategoriKategori extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pengaduans: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPengaduanPengaduan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status_laporan: Schema.Attribute.Enumeration<
      ['Menunggu', 'Proses', 'Selesai', 'Invalid']
    > &
...
export interface ApiSiswaSiswa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nis: Schema.Attribute.BigInteger & Schema.Attribute.Unique;
    password: Schema.Attribute.String;
    pengaduans: Schema.Attribute.Relation<
      'oneToMany',
      'api::pengaduan.pengaduan'
